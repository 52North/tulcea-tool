"""
Django settings for TulceaTool project.
...
ANONYMOUS_PERMISSIONS = [
    ...
    'watersupplier.add_watersupplier',
    'energyusage.add_energyusage',
    'productionservice.add_productionservice',
]
