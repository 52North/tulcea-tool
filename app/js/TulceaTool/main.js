define(['wq/app', 'wq/map', 'wq/patterns', 'wq/photos', './hide', './welcome', 'wq/locate', './config', 'leaflet.draw', 'leaflet.markercluster'],
function(app, map, patterns, photos, hide, welcome, locate, config) {
